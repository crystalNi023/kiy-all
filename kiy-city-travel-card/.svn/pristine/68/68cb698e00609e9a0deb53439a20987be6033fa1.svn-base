...
public class FPrompt extends Dialog {
	...
	private void createContents() {
		...
		labelImage.setImage(SWTResourceManager.getImage(FPrompt.class, "/com/kiy/resources/alarm.png"));
	...
	private void makeSuccess(String text) {
		...
		shell.setText("提示");
		labelText.setText(text);
		labelImage.setImage(SWTResourceManager.getImage(FPrompt.class, "/com/kiy/resources/success.png"));
		buttonClose.setVisible(true);
		buttonRetry.setVisible(false);
		buttonCancel.setVisible(false);
		buttonAccept.setVisible(false);
