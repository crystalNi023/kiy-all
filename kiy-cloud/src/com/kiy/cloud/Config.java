...
//	public final static String IMG_URL = "http://192.168.0.215:8090/data/";
	public static final String IMG_URL = "http://cloud.athenall.com:8080/data/";
	
	// mybatis配置文件路径
	public static final String MYBATIS_CONFIG_URL = "mybatisConfig.xml";
	
	// 阿里云语音接口地址
	public static final String RECOGNIZE_URL = "http://nlsapi.aliyun.com/recognize?model=chat";
	// 阿里云语音合成地址
	public static final String SPEECH_SYNTHESIS = "http://nlsapi.aliyun.com/speak?encode_type=wav&voice_name=xiaoyun&volume=50&sample_rate=8000&speech_rate=0&pitch_rate=0&tts_nus=1&background_music_id=0&background_music_offset=0&background_music_volume=100";
