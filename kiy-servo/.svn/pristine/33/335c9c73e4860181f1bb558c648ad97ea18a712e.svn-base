...
/**
 * 可以实现按格式保存配置文件与注释的Properties工具类
 * 
 * @author HLX Tel:18996470535
 * @date 2018年7月4日 Copyright:Copyright(c) 2018
 */
public class SafeProperties extends Properties {
	...
	public synchronized void load(InputStream inStream, String charsetName) throws IOException {
		...
		in = new BufferedReader(new InputStreamReader(inStream, charsetName));
		while (true) {
	 ...
	 * @throws IOException
	 */
	public synchronized void store(OutputStream out, String header, String charsetName) throws IOException {
