...
CREATE TABLE `linkages` (
  ...
  INDEX `ix_linkage_updated` (`updated` ASC)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8;

CREATE TABLE `linkage_devices` (
  `id` char(36) NOT NULL,
  `linkage_id` char(36) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_linkage_devices_device_id_idx` (`device_id` ASC),
  INDEX `fk_linkage_devices_linkages_id_idx` (`linkage_id` ASC)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8;
...
CREATE TABLE `push` (
  ...
  `device_tokens` VARCHAR(64) NOT NULL,
  `device_type` int(11) NOT NULL,
  `remark` VARCHAR(128)  NULL,
    `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ,
...
CREATE TABLE `question` (
  ...
  `updated` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ix_servo_updated` (`updated`) USING BTREE
) ENGINE=INNODB DEFAULT CHARACTER SET=UTF8;
