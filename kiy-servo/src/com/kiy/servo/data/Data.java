...
public final class Data {
	...
	public static Set<XMCamera> selectCamera() {
		return DB.SelectCamera();
	}
	
	public static boolean CreateCamera(XMCamera camera) {
		return DB.CreateCamera(camera);
	}
	public static Set<XMDevice> selectXMDevice() {
		return DB.SelectXMDevice();
	}
	
	public static boolean CreateXMDevice(XMDevice xmDevice) {
		return DB.CreateXMDevice(xmDevice);
	} 
	
	public static boolean UpdateXMDevice(XMDevice xmDevice) {
		return DB.UpdateXMDevice(xmDevice);
	}
	
	public static boolean deleteXMDevice(XMDevice xmDevice) {
		return DB.DeleteXMDevice(xmDevice);
	}
	
	public static Question CreateQuestion(Question question) {
		if (!DB.CreateQuestion(question)) {
			question = null;
		}
		return question;
	}
	public static Set<Question> selectQuestion(String userId) {
		return DB.SelectQuestion(userId);
	}
	public static DeviceLogin CreateDeviceLogin(DeviceLogin deviceLogin) {
		if (!DB.CreateDeviceLogin(deviceLogin)) {
			deviceLogin = null;
		}
		return deviceLogin;
	}
	public static Set<DeviceLogin> SelectDeviceLogins(String userId) {
		return DB.SelectDeviceLogins(userId);
	}
	public static DeviceLogin UpdateDeviceLogin(DeviceLogin deviceLogin) {
		if(DB != null && deviceLogin != null){
			if(!DB.UpdateDeviceLogin(deviceLogin)){
				deviceLogin = null;
			}
		}
		return deviceLogin;
	}
	public static void addOfflineNotice(String deviceId,String content){
		DC.addOfflineNotice(deviceId, content);
	}
	public static String getOfflineNotice(String deviceId){
		return DC.getOfflineNotice(deviceId);
	}
	public static void deleteOfflineNotice(String deviceId){
		DC.deleteOfflineNotice(deviceId);
	}
}